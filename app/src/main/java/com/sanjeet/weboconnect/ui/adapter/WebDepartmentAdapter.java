...
import static com.sanjeet.weboconnect.ui.MainActivity.comingWebEmp;
...
public class WebDepartmentAdapter extends RecyclerView.Adapter<WebDepartmentAdapter.ViewHolder> {
    ...
    private OnWebRemoveBtnClickListener onWebRemoveBtnClickListener;
    ...
    public WebDepartmentAdapter(List<Employee> employeeList, Context context, OnWebRemoveBtnClickListener onWebRemoveBtnClickListener) {
        this.employeeList = employeeList;
        this.context = context;
        this.onWebRemoveBtnClickListener = onWebRemoveBtnClickListener;
    }

    @NonNull
    @Override
    public WebDepartmentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.employee_row_item, parent, false);
        return new ViewHolder(view, onWebRemoveBtnClickListener);
    }

    @Override
    public void onBindViewHolder(@NonNull WebDepartmentAdapter.ViewHolder holder, int position) {
        ...
        if (comingWebEmp.size() > 0) {
            for (int i = 0; i < comingWebEmp.size(); i++) {
                String[] employee1 = comingWebEmp.toArray(new String[comingWebEmp.size()]);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        OnWebRemoveBtnClickListener onWebRemoveBtnClickListener;

        public ViewHolder(@NonNull View itemView, OnWebRemoveBtnClickListener onWebRemoveBtnClickListener) {
            super(itemView);
            this.onWebRemoveBtnClickListener = onWebRemoveBtnClickListener;
            ...
            tvRemove.setOnClickListener(view -> {
                if (onWebRemoveBtnClickListener != null) {
                    int position = getAdapterPosition();
                    if (position != RecyclerView.NO_POSITION) {
                        onWebRemoveBtnClickListener.onWebRemoveBtnClickListener(position);
                    }
                }
            });
        }
